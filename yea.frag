...
void main()
{
    vec2 mo = vec2(640, 360).xy;
	float time = 32.0 + 0.0*1.5;
    ...
    for( int n=ZERO; n<AA; n++ )
    {
        ...
        vec2 p = (2.0*(fragCoord+o)-vec2(640, 360).xy)/vec2(640, 360).y;
#else    
        vec2 p = (2.0*fragCoord-vec2(640, 360).xy)/vec2(640, 360).y;
#endif
        ...
        vec3 rd = ca * normalize( vec3(p,-fl) );
         ...
         // ray differentials
        vec2 px = (2.0*(fragCoord+vec2(1.0,0.0))-vec2(640, 360).xy)/vec2(640, 360).y;
        vec2 py = (2.0*(fragCoord+vec2(0.0,1.0))-vec2(640, 360).xy)/vec2(640, 360).y;
